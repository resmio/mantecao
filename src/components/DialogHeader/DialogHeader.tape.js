...
test('DialogHeader renders an UnstyledButton when passed a close function', function(
  t
) {
  const onClose = spy()
...
test('DialogHeader does not render an UnstyledButton without props', function(
  t
) {
